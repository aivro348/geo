...
const fullGisSection = `<div className="gis-premium-wrapper">
...
let startIndex = content.indexOf("<div style={{ backgroundColor: 'white', padding: '50px'");
let preciseEndIndex = content.indexOf('        ) : (', startIndex);

if (startIndex !== -1 && preciseEndIndex !== -1) {
  content = content.substring(0, startIndex) + fullGisSection + '\n' + content.substring(preciseEndIndex);
